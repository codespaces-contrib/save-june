...
- **Live reload:** Once you've run the app, try changing code and saving it. The web app should automatically reload! For example, edit the `<title>` element in `views/index.ejs` and watch the tab update once you hit `cmd+s` 🔥
